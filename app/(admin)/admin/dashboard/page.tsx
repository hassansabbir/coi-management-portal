...
import { INITIAL_CLIENTS, INITIAL_CERTIFICATES, INITIAL_ACTIVITIES } from '@/lib/mockData';
      ...
      <main className="flex-1 p-6 lg:p-8 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
          ...
          <StatCard
            ...
            value={INITIAL_CERTIFICATES.length + 4}
            subtitle="All documents"
          />
        </div>

        {/* Dashboard Columns matching Image 2 Layout */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          {/* Left Column: Recent Clients List (7 cols) */}
          <div className="lg:col-span-7">
            <RecentClientsList clients={INITIAL_CLIENTS} />
          </div>

          {/* Right Column: Recent Activity Feed (5 cols) */}
          <div className="lg:col-span-5">
            <RecentActivityFeed activities={INITIAL_ACTIVITIES} />
          </div>
        </div>
      </main>
